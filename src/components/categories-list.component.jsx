...
export default class CategoriesList extends Component {
  ...
  render() {
    const { searchName, categories, currentCategory, currentIndex, products } = this.state;
    ...
    return (
      <div className="list row">
        ...
        <div className="col-md-6">
          ...
          <button className="m-3 btn btn-sm btn-danger" onClick={this.removeAllCategories}>
            Remove All
          </button>
        </div>
        <div className="col-md-6">
          {currentCategory ? (
            <div>
              ...
              <Link to={'/categories/' + currentCategory.id} className="badge badge-warning">
                Edit
              </Link>
